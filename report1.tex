...
Using Incremental Solver we have performed reaching definition analysis. Specification for reaching definition analysis consist of following parts:
\begin{itemize}
...
\item \textbf{A name can refer to a single variable in a program at any given program point.}
\item \textbf{The past information is stored flow sensitively.}
...
Late discovery of this issue has prevented any corrective measures. Therefore, we take the above two assumptions. 
...
\section{Testing}
In the absence of serialization of IR, it was not possible to test the code for real world application.
...
\putnode{n10}{n8}{0}{-13}{%
     \psframebox[linewidth=.3,framesep=1.5, framearc=.4]{func1( )}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Issues in Incremental Analysis in General framework}
...
\section{Issues in Incremental Analysis for Constant Propagation Analysis}
...
with savings of up to X\% in terms of data flow information computed.
...
\begin{itemize}
 ...
 \item \textbf{Creation of Affected Region} From the fact that creation of affected region is a analysis specific, the code for this has to be written manually.
