...
\section{Dominance Frontier}\cite{}
Before describing the issues in incremental analysis, we first define the concept of \textit{Dominance Frontier}.
...
by the concept of \emph{dominance frontier}.

of optimizing the size of the affected region in the general case.
...
\putnode{n7}{n6}{0}{-15}{%
     \psframebox[linewidth=.3,framesep=1.7]{\hspace{10mm}}}
\rput(49,5){\rnode{c}{n7}}
\rput(47,8){\rnode{c1}{\blue$\langle b=3 \rangle$}}
\rput(47,1){\rnode{c2}{\blue$\langle b=3 \rangle$}}
